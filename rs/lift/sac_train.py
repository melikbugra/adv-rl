"""
SAC training script for robosuite Lift with dense reward.

Lift is the simplest robosuite task: pick up a cube from the table.
Observation: 60-dim flat (robot proprio 46 + object state 14)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="SAC training for robosuite Lift",
    )
    parser.add_argument(
        "--timesteps",
        type=int,
